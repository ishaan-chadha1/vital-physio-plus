...
console.log("✅ ENV Vars Available:", process.env.NEXT_PUBLIC_GEMINI_API_KEY);
...
if (!API_KEY) {
  ...
  throw new Error("API Key is missing! Make sure NEXT_PUBLIC_GEMINI_API_KEY is set in .env.local");
}
