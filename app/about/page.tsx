  ...
  const features = [
    {
      ...
      description: "Our team comprises highly qualified physiotherapists with advanced certifications, committed to evidence-based practice for effective care.",
    },
    {
      icon: HeartHandshake,
      title: "Personalized Care, Tailored for You",
      description: "We provide one-to-one treatment sessions and individualized plans tailored to your specific needs, addressing root causes for holistic healing.",
    },
    {
      icon: Sparkles,
      title: "Advanced Techniques & Technology",
      description: "Utilizing cutting-edge equipment and innovative therapies like laser and advanced manual techniques to ensure forward-thinking care.",
    },
    {
      icon: BrainCircuit,
      title: "A Holistic Approach to Well-being",
      description: "We focus on your overall well-being, aiming to improve long-term health and empower you with the knowledge to maintain your vitality.",
    },
  ];
