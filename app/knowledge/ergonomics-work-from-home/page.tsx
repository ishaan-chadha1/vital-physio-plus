    ...
    <>
      ...
      <section className="bg-gray-50 py-16 md:py-20">
        <div className="max-w-4xl mx-auto px-6">
          {/* SEO Meta Tags */}
          <head>
            <title>Ergonomics for Work-from-Home | VitalPhysio⁺ Bengaluru</title>
            <meta
              name="description"
              content="Discover physiotherapy-certified ergonomic tips for IT professionals working from home in Bengaluru. Improve posture, reduce pain, and boost productivity."
            />
            <meta
              name="keywords"
              content="ergonomics, work from home, physiotherapy, Bengaluru, IT professionals, posture correction, remote work tips"
            />
          </head>
