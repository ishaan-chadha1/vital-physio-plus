    ...
    <>
      ...
      <section className="bg-gray-50 py-16 md:py-20">
        <div className="max-w-4xl mx-auto px-6">
          {/* SEO Meta Tags */}
          <head>
            <title>Physiotherapy for Chronic Low Back Pain | VitalPhysio⁺ Bengaluru</title>
            <meta
              name="description"
              content="Discover evidence-based physiotherapy solutions for chronic low back pain at VitalPhysio⁺ Bengaluru. Learn myths, facts, and recovery pathways."
            />
            <meta
              name="keywords"
              content="low back pain, physiotherapy, chronic pain, VitalPhysio⁺, Bengaluru, posture correction, core strengthening, manual therapy"
            />
          </head>
