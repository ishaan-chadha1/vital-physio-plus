...
export default function KneePainExercises() {
  React.useEffect(() => {
    (async function () {
    ...
    <>
      ...
      <section className="bg-gray-50 py-16 md:py-20">
        <div className="max-w-4xl mx-auto px-6">
          {/* SEO Meta Tags */}
          <head>
            <title>5 Key Exercises After Knee Surgery | VitalPhysio⁺ Bengaluru</title>
            <meta
              name="description"
              content="Discover the importance of post-surgical rehabilitation and 5 key exercises for knee recovery at VitalPhysio⁺ Bengaluru."
            />
            <meta
              name="keywords"
              content="knee surgery, post-surgical rehabilitation, physiotherapy, VitalPhysio⁺, Bengaluru, water treadmill therapy, knee exercises"
            />
          </head>
