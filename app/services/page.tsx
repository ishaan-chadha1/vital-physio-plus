...
const conditionDetails = {
  "Joint injuries": {
    ...
    highlights: [
      {
        ...
        content: "Every patient receives a thorough biomechanical evaluation using the latest assessment tools—identifying structural and functional deficits for a truly personalized plan."
      },
      {
        title: "Precision Treatment Protocols", 
        content: "We combine manual therapy, targeted exercise prescription, and progressive loading to restore joint stability, mobility, and strength."
      },
      {
        title: "Advanced Modalities",
        content: "Where indicated, we integrate regenerative medicine approaches, shockwave therapy, high-intensity laser, and rPMS (Repetitive Peripheral Magnetic Stimulation) for enhanced tissue healing and pain relief."
      },
      {
        title: "Cutting-Edge Technology",
        content: "Our use of wearable sensors, AI-driven movement analysis, and state-of-the-art equipment ensures real-time progress tracking and highly individualized rehabilitation."
      },
      {
        title: "Education & Self-Management",
        content: "Patients and caregivers receive guidance on activity modification, safe return-to-sport, bracing/support options, and injury prevention—promoting long-term joint health."
      }
    ],
    treatmentAreas: [
    ...
    importanceNote: "Prompt, expert-guided rehab after joint injury dramatically reduces pain, restores function, and decreases long-term risk of arthritis or reinjury. Our physiotherapists collaborate with orthopedic surgeons as needed for seamless post-operative transitions.",
    ctaMessage: "Book a consultation and take the first step toward pain-free movement and lasting joint health."
    },
    "Chronic pain": {
    ...
    highlights: [
      {
        ...
        content: "We use detailed pain assessment tools, functional movement analysis, and biopsychosocial profiling to create a deeply personalized plan—addressing physical, psychological, and lifestyle contributors to ongoing pain."
      },
      {
        title: "Multimodal Treatment Approach", 
        content: "Interventions include clinically proven manual therapy, therapeutic exercise, posture correction, and movement retraining, all shown to improve function and reduce pain severity."
      },
      {
        title: "Mind-Body Therapies",
        content: "Our programs integrate mindfulness, stress management, and education in pacing and flare-up strategies—empowering patients to control pain and improve mood."
      },
      {
        title: "Advanced Modalities",
        content: "When appropriate, we offer evidence-supported treatments such as high-intensity laser therapy, TENS, electromyography biofeedback, hydrotherapy, and movement-based reality experiences."
      },
      {
        title: "Team-Based, Coordinated Care",
        content: "For complex or persistent pain, our physiotherapists coordinate closely with pain specialists, psychologists, and physicians for truly integrated rehabilitation, in line with global best practice guidelines."
      }
    ],
    treatmentAreas: [
    ...
    importanceNote: "Timely, specialist-led physiotherapy for chronic pain has been proven to reduce disability, minimize medication dependence, and optimize patient outcomes. Evidence strongly supports non-pharmacological, active management as first-line chronic pain care—validated by WHO guidelines.",
    ctaMessage: "Take the next step—regain control, reduce pain, and restore your best life with VitalPhysio⁺. Book your chronic pain assessment today."
  },
  "Muscle strains": {
  ...
  highlights: [
    {
      ...
      content: "Every patient undergoes detailed examination with functional movement screening to precisely determine the location, severity, and grade of muscle strain—ensuring a customized rehabilitation plan for optimal outcomes."
    },
    {
      title: "Comprehensive Treatment Approach", 
      content: "Our protocols follow the latest scientific guidelines, combining acute care (RICE protocol), progressive stretching, strengthening exercises, hands-on therapy, and regenerative modalities when indicated."
    },
    {
      title: "Functional Rehabilitation",
      content: "Return-to-activity is structured, with clear milestone-based progression, sport-specific retraining, and real-time movement feedback to ensure a safe and confident return to work, sports, or daily living."
    },
    {
      title: "Education & Self-Management",
      content: "We empower you with practical strategies for safe stretching, warm-up/cool-down routines, nutrition, hydration, and overuse prevention—essential for maintaining muscle health."
    },
    {
      title: "Advanced Recovery Modalities",
      content: "When indicated, advanced treatments such as platelet-rich plasma (PRP), high-intensity laser, and shockwave therapy for enhanced healing—backed by latest evidence."
    }
  ],
  treatmentAreas: [
  ...
  importanceNote: "Early, expert-guided muscle strain rehabilitation significantly reduces recovery time, prevents chronic complications, and minimizes re-injury risk. Our evidence-based approach ensures optimal healing and safe return to activities.",
  ctaMessage: "Book your assessment—experience tailored care, faster recovery, and lasting results."
},
"Arthritis": {
  title: "Arthritis – Evidence-Based Physiotherapy for Relief, Mobility, and Independence",
  ...
  highlights: [
    {
      ...
      content: "Every patient receives a full musculoskeletal, functional, and lifestyle evaluation—identifying the type, stage, and impact of arthritis to tailor the ideal, patient-specific program."
    },
    {
      title: "Multimodal Physiotherapy", 
      content: "We implement evidence-based interventions such as targeted therapeutic exercise, manual therapy & joint mobilization, aquatic therapy & Pilates, pain management modalities, bracing and orthotic support, and assistive device guidance."
    },
    {
      title: "Integrated Team Approach",
      content: "Our physiotherapists collaborate with rheumatologists and orthopedic specialists, as needed, to deliver fully coordinated care."
    },
    {
      title: "Education & Self-Management",
      content: "Patients learn joint protection, pacing, weight management strategies (including diet recommendations like the Mediterranean and anti-inflammatory diet), and energy conservation techniques—empowering sustainable, long-term self-care."
    }
  ],
  treatmentAreas: [
  ...
  importanceNote: "Evidence-based physiotherapy for arthritis has been proven to significantly reduce pain, improve joint mobility, and enhance quality of life. Early intervention with specialized care can slow disease progression and maintain independence for longer periods.",
  ctaMessage: "Take control of your arthritis with a holistic program proven to improve mobility, reduce pain, and enhance life quality. Book your evaluation at VitalPhysio⁺ today!"
},
"Back pain": {
  title: "Back Pain – Comprehensive Relief—Personalized, Non-Surgical Rehabilitation",
  ...
  highlights: [
    {
      ...
      content: "Every case begins with a thorough clinical, functional, and postural evaluation—including assessment for disc issues, nerve involvement, and lifestyle factors. This ensures a precise, patient-centered diagnosis and the right treatment pathway."
    },
    {
      title: "Evidence-Based Physiotherapy Techniques", 
      content: "Our protocols are guided by global best practices, including therapeutic exercise, manual therapy, pain management modalities, and education and self-management—all individualized for acute, subacute, or chronic back pain."
    },
    {
      title: "Active, Non-Surgical Recovery",
      content: "Most cases of spine and back pain do not require surgery. Our proven approach promotes movement, safe activity, and gradual return to daily life—reducing reliance on medication and delivering long-term results."
    },
    {
      title: "Advanced Treatment Modalities",
      content: "We offer cutting-edge options such as TENS, high-intensity laser, shockwave therapy, and, where indicated, platelet-rich plasma (PRP) for persistent pain relief and enhanced healing."
    },
    {
      title: "Comprehensive Self-Management Education",
      content: "Patients are empowered with ergonomics training, activity modification strategies, and back care education to maintain results and prevent recurrence."
    }
  ],
  treatmentAreas: [
  ...
  importanceNote: "Evidence-based physiotherapy is the gold standard for back pain management, with proven efficacy in reducing pain, improving function, and preventing recurrence. Early intervention with specialist care significantly improves outcomes and reduces the likelihood of chronic pain development.",
  ctaMessage: "Book your back pain assessment for a return to pain-free movement, improved posture, and renewed quality of life."
},
"Sports injuries": {
  ...
  highlights: [
    {
      ...
      content: "Every athlete or active individual receives a thorough biomechanical, functional, and sport-specific evaluation—pinpointing not just the injury, but the underlying movement patterns and risk factors."
    },
    {
      title: "Individualized, Activity-Specific Rehabilitation", 
      content: "Treatment is tailored to your sport, position, and personal goals. Protocols include acute phase care, progressive strengthening and neuromuscular retraining, sport-specific agility training, manual therapy and advanced modalities, and injury prevention strategies."
    },
    {
      title: "Return-to-Play Decision Making",
      content: "We use defined milestones, objective strength/function testing, and psychological readiness screening to ensure safe, confident return to full sport participation—with ongoing support and monitoring."
    },
    {
      title: "Integrated, Interdisciplinary Sports Medicine Team",
      content: "Collaboration with orthopedic and sports medicine specialists, nutritionists, and strength/conditioning coaches ensures the highest standards in care and performance."
    }
  ],
  treatmentAreas: [
  ...
  importanceNote: "Early, specialized sports injury rehabilitation significantly reduces recovery time, prevents chronic complications, and optimizes return to sport performance. Our evidence-based approach ensures athletes return stronger, faster, and with reduced reinjury risk.",
  ctaMessage: "Get back to top form—book your sports injury assessment at VitalPhysio⁺ and experience the gold standard in recovery."
},
"Performance enhancement": {
  ...
  highlights: [
    {
      ...
      content: "Biomechanical analysis, strength and power testing, movement screening, and sport-specific profiling identify your unique strengths and performance gaps. Custom data-driven plans ensure precision targeting for speed, explosiveness, stability, and endurance improvements."
    },
    {
      title: "Individualized, Progressive Training Plans", 
      content: "Strength, agility, flexibility, plyometric, and neuromuscular control programs are sport/goal-specific and continually adapted to your response and feedback. Evidence-based mobility/recovery techniques to optimize load, minimize fatigue, and build resilience."
    },
    {
      title: "Advanced Technology Integration",
      content: "Wearable performance trackers, force plates, video motion analysis, and real-time biofeedback tools give actionable insights for rapid gains. Sport-specific movement retraining and correction of inefficient or injury-prone patterns for lasting results."
    },
    {
      title: "Injury Risk Reduction & Longevity",
      content: "Personalized prehabilitation routines, dynamic warm-up/cool-down guidance, and ongoing technique optimization help future-proof your body. Education in nutrition, hydration, mental preparation, and sleep supports holistic performance."
    },
    {
      title: "Elite Return-to-Play & Event Preparation",
      content: "Specialized peaking protocols for competitive athletes, including taper planning, mental skills training, and competition simulation. Return-to-play after injury is managed via milestone-based strength/power testing, reconditioning, and psychological readiness screens."
    }
  ],
  treatmentAreas: [
  ...
  importanceNote: "Performance enhancement through evidence-based sports physiotherapy significantly improves athletic performance, reduces injury risk, and extends athletic careers. Our comprehensive approach ensures sustainable improvements in strength, speed, agility, and overall athletic capacity.",
  ctaMessage: "Be proactive, not reactive—book your personalized injury prevention screening today. Protect your health, unlock better movement, and perform with confidence."
},
"Return to sport": {
  title: "Return to Sport – Safe, Science-Led Pathways—From Recovery to Peak Performance",
  ...
  highlights: [
    {
      ...
      content: "Return-to-sport is never determined by time alone; instead, we use validated strength, power, agility, and sport-specific testing batteries to ensure every athlete meets physical prerequisites for safe reintegration. Testing includes single leg hops, change-of-direction, sprint and power metrics, psychological readiness scores, and movement quality screens."
    },
    {
      title: "Personalized On-Field Rehabilitation", 
      content: "Milestone-driven on-field sessions simulate sport intensity, using real play scenarios, while continuously monitoring pain, swelling, biomechanics, and confidence. Advanced wearable tech and heart rate monitoring dial in workload, ensuring metabolic and neuromuscular fitness matches your sport's highest demands."
    },
    {
      title: "Multidisciplinary Team Collaboration",
      content: "Our physiotherapists work in concert, as needed, with sports physicians, orthopedic surgeons, S&C coaches, mental health specialists, and your personal trainers for seamless, 360° support throughout the return-to-sport continuum."
    },
    {
      title: "Psychological & Contextual Readiness",
      content: "Return-to-sport is optimized when physical capability is matched with psychological confidence and context awareness. Guided education, expectation setting, and psychological readiness screening reduce fear and foster enthusiasm for return."
    },
    {
      title: "Injury Prevention Integration",
      content: "Every program includes prehabilitation, load management, movement retraining, and monitoring for persistent deficits—a proven way to reduce reinjury rates and prolong sporting careers."
    }
  ],
  treatmentAreas: [
  ...
  importanceNote: "Evidence-based return-to-sport protocols significantly reduce reinjury rates and optimize long-term athletic performance. Our comprehensive approach ensures athletes return with confidence, improved movement quality, and reduced risk of future injuries.",
  ctaMessage: "Ready to get back in the game—confident, conditioned, and resilient? Book your Return to Sport assessment now for Bengaluru's gold standard in sporting rehab."
},
"Athletic conditioning": {
  ...
  highlights: [
    {
      ...
      content: "Biomechanical, metabolic, and performance testing identify strengths and growth areas. Screening includes range of motion, power, balance, core stability, endurance, and sport-specific skills."
    },
    {
      title: "Custom Programming for All Sports & Levels", 
      content: "Periodized, progressive strength and hypertrophy plans build foundational and sport-specific power. Agility, plyometric, speed, and change-of-direction drills develop quickness and movement efficiency relevant to your game. Cardiovascular fitness and metabolic conditioning enhance stamina and recovery capacity."
    },
    {
      title: "Correction of Deficits and Weak Chains",
      content: "Addressing movement asymmetries, muscle imbalances, and flexibility restrictions minimizes injury risk and supports maximal efficiency. Neuromuscular retraining and proprioception drills fine-tune the athletic \"engine.\""
    },
    {
      title: "Technology-Driven Progress Tracking",
      content: "Wearables, force plates, and video analysis deliver actionable performance data and proof of gains."
    },
    {
      title: "Education & Lifestyle Guidance",
      content: "Nutritional, hydration, mental skills, and recovery strategies are included to holistically support peak training and competition."
    }
  ],
  treatmentAreas: [
  ...
  importanceNote: "Athletic conditioning through evidence-based sports science significantly improves performance metrics, reduces injury rates, and extends athletic careers. Our comprehensive approach ensures sustainable improvements in strength, power, speed, agility, and sport-specific capacity.",
  ctaMessage: "Ready to level up your athletic career? Book your personalized athletic conditioning assessment and start your journey to peak performance—backed by world-class science and coaching."
},
"Joint replacement recovery": {
  title: "Joint Replacement Recovery – Rapid Restoration—Mobility, Strength, and Independence",
  ...
  importanceNote: "Expert post-operative rehabilitation is crucial for successful joint replacement outcomes. Evidence shows that structured, progressive physiotherapy significantly improves functional recovery, reduces complications, and enhances long-term joint survival and quality of life.",
  ctaMessage: "Ready for a confident recovery after joint replacement surgery? Book your post-op assessment for Bangalore's best evidence-based joint replacement rehab."
},
"ACL repair": {
  title: "ACL Repair – Return to Strength, Stability, and Sport—Evidence-Driven Recovery",
  subtitle: "Comprehensive ACL Repair & Reconstruction Rehabilitation at VitalPhysio⁺",
  ...
  highlights: [
    {
      ...
      content: "Recovery is tailored, not just timed. Progress is determined by clinical milestones—pain/swelling reduction, gait normalization, strength symmetry, and movement quality. Early phases focus on pain control, swelling management, safe mobility, and neuromuscular activation of the quadriceps and hamstrings. Later phases include advanced strength, endurance, proprioception, running progressions, and gradual sports integration as you meet objective functional criteria."
    },
    {
      title: "Integrated Proprioceptive and Neuromuscular Training", 
      content: "Our protocols combine strength work with advanced proprioceptive and neuromuscular retraining—proven to reduce reinjury rates and build lifelong joint health. Balance board, agility, and single-leg drills bridge the gap from basic recovery to high-level sport."
    },
    {
      title: "Return-to-Sport Decision Making",
      content: "Return to running, jumping, and pivoting is based on validated testing—strength (at least 90% symmetry), hop, agility, and confidence—not arbitrary timelines. Psychological readiness and sport-specific skills training are integrated for complete, risk-reduced comeback."
    },
    {
      title: "Technology-Enhanced Rehab",
      content: "Wearables, digital feedback, biofeedback, and remote monitoring support real-time progress and motivation."
    },
    {
      title: "Education & Family-Support",
      content: "Every patient and their support system is trained in safe recovery, swelling/pain management, use of braces or aids, prevention of future injury, and what to expect at every stage."
    }
  ],
  treatmentAreas: [
  ...
  importanceNote: "Evidence-based ACL rehabilitation significantly reduces reinjury rates and optimizes return to sport performance. Our comprehensive, criterion-driven approach ensures athletes return stronger, more confident, and with reduced risk of future ACL injuries.",
  ctaMessage: "Regain your strength, confidence, and peak performance. Book your specialist ACL rehab at VitalPhysio⁺—Bangalore's leader in sports injury recovery."
},
"Post-surgical rehabilitation": {
  title: "Post-surgical Rehabilitation – Accelerated Recovery—Restoring Strength, Mobility, and Function",
  ...
  highlights: [
    {
      title: "Water Treadmill: Cutting-Edge Therapy for Joint Replacement Recovery",
      content: "Our state-of-the-art facility includes dedicated aquatic therapy and water treadmill sessions for all eligible joint replacement patients—hip, knee, and ankle."
    },
    {
      title: "Early, Pain-Free Mobility", 
      content: "Buoyancy reduces body weight, allowing earlier walking and movement after hip, knee, or ankle replacement, with much less pain and joint strain than on land."
    },
    {
      title: "Reduced Swelling and Improved Circulation",
      content: "Hydrostatic pressure and gentle resistance of water decrease post-op edema and boost blood flow, speeding healing."
    },
    {
      title: "Enhanced Muscle Strength and Gait",
      content: "The resistance of water builds muscle and restores a normal walking pattern (gait) long before it is possible on land, preventing muscle wastage and promoting balance."
    },
    {
      title: "Faster Range of Motion Gains",
      content: "Patients achieve crucial bending and extension goals for hip and knee earlier, supporting better long-term outcomes."
    },
    {
      title: "Lower Fall Risk, Greater Confidence",
      content: "Supported, slip-free walking environment reduces fear and the risk of falling—particularly beneficial for older adults after replacement surgery."
    },
    {
      title: "Proven Results",
      content: "Research shows that combining water treadmill with conventional physiotherapy leads to faster, more complete recovery—including superior joint range, strength gains, and function."
    }
  ],
  treatmentAreas: [
  ...
  importanceNote: "Post-surgical rehabilitation is crucial for optimal recovery outcomes. Evidence shows that structured, progressive physiotherapy combined with innovative modalities like water treadmill therapy significantly improves functional recovery, reduces complications, and enhances long-term surgical success.",
  ctaMessage: "Start your journey to complete recovery with our advanced post-surgical rehabilitation program. Book your assessment for faster, safer, and more effective healing."
},
"Wound healing": {
  title: "Wound Healing – Advanced Recovery—Minimizing Scarring, Restoring Function",
  ...
  highlights: [
    {
      ...
      content: "Thorough wound assessment including size, depth, type (surgical, pressure, diabetic, traumatic), and contributing factors (circulation, mobility, nutrition). Care plans tailored to the wound, underlying medical issues, and patient goals."
    },
    {
      title: "Advanced Physical Therapy Modalities", 
      content: "Electrical stimulation and electromagnetic field therapy: Promotes faster tissue repair, reduces edema, and minimises infection. Laser and photobiomodulation: Proven to accelerate healing, reduce pain, and minimize scarring (including for chronic or slow-to-heal wounds). Ultrasound therapy: Enhances blood flow, improves cellular repair, and encourages granulation tissue development. Manual lymphatic drainage and targeted movement: Reduces swelling and improves circulation for optimal healing."
    },
    {
      title: "Comprehensive Wound Management",
      content: "Best-practice wound care including specialized dressings, infection control, and offloading (for pressure or diabetic wounds) in collaboration with physicians and wound care nurses, as needed. Early mobilization (following ERAS principles) decreases post-op complications, supports tissue oxygenation, and enhances overall recovery."
    },
    {
      title: "Education & Prevention",
      content: "Patient/caregiver guidance in wound hygiene, early detection of infection, and lifestyle promotion for better healing (nutrition, hydration, glycemic control, and pressure preservation)."
    }
  ],
  treatmentAreas: [
  ...
  importanceNote: "Advanced wound healing therapy significantly reduces healing time, minimizes complications, and improves tissue quality outcomes. Our evidence-based approach ensures optimal recovery while reducing the risk of infection and chronic wound development.",
  ctaMessage: "Want pain-free, rapid, and complete healing? Book a wound healing evaluation at VitalPhysio⁺—Bangalore's top choice for post-surgical and complex wound recovery."
},
"Mobility restoration": {
  title: "Mobility Restoration – Regain Independence—Restore Strength, Confidence, and Life",
  ...
  importanceNote: "Specialized mobility restoration significantly improves functional outcomes and quality of life. Evidence shows that comprehensive, progressive rehabilitation reduces disability, enhances independence, and accelerates return to meaningful activities and participation in life.",
  ctaMessage: "Ready to restore your movement and freedom? Book a personalized mobility assessment at VitalPhysio⁺—Bangalore's trusted center for recovery and independence."
},
"Stroke recovery": {
  ...
  importanceNote: "Early, high-intensity, and multidisciplinary stroke rehabilitation is proven to maximize recovery and significantly improve functional outcomes. Evidence shows that intensive, task-oriented therapy promotes neuroplasticity and enhances quality of life for stroke survivors.",
  ctaMessage: "Ready to reclaim your life and independence? Book a personalized stroke recovery assessment at VitalPhysio⁺—Bangalore's best for advanced neurological rehab."
},
"Parkinson's disease": {
  ...
  importanceNote: "Evidence-based Parkinson's rehabilitation significantly slows disease progression, improves motor function, and enhances quality of life. Early and ongoing physiotherapy intervention is crucial for maintaining independence and reducing fall risk in PD patients.",
  ctaMessage: "Ready to fight back against Parkinson's movement challenges? Book your advanced Parkinson's rehabilitation consultation at VitalPhysio⁺."
},
"Multiple sclerosis": {
  title: "Multiple Sclerosis – Maintain Strength, Movement, and Everyday Potential",
  ...
  importanceNote: "Comprehensive MS rehabilitation significantly improves functional capacity, reduces disability progression, and enhances quality of life. Evidence supports early and ongoing intervention to maintain independence and manage symptoms effectively.",
  ctaMessage: "Ready for more movement, stability, and confidence with MS? Book your personalized MS assessment at VitalPhysio⁺."
},
"Spinal cord injuries": {
  title: "Spinal Cord Injuries – Maximizing Recovery, Independence, and Life Participation",
  ...
  importanceNote: "Early and comprehensive spinal cord injury rehabilitation significantly improves functional outcomes and quality of life. Evidence shows that intensive, activity-based therapy promotes neuroplasticity and can lead to meaningful recovery even years after injury.",
  ctaMessage: "Ready for expert, hope-driven SCI recovery? Book your holistic spinal cord injury assessment at VitalPhysio⁺."
},
"Brain injuries": {
  title: "Brain Injuries – Comprehensive Neurorehabilitation for Recovery and Independence",
  ...
  highlights: [
    {
      ...
      content: "Thorough evaluation of cognitive, motor, sensory, and functional abilities to develop personalized rehabilitation plans targeting specific deficits and recovery goals."
    },
    {
      title: "Neuroplasticity-Based Interventions", 
      content: "Task-specific training, repetitive practice, and functional activities designed to promote brain reorganization and recovery of lost functions through evidence-based neuroplasticity principles."
    },
    {
      title: "Multidisciplinary Approach",
      content: "Coordinated care involving physiotherapy, occupational therapy, speech therapy, neuropsychology, and medical management for comprehensive rehabilitation addressing all aspects of recovery."
    },
    {
      title: "Family and Caregiver Support",
      content: "Education and training for families and caregivers to support recovery goals, manage symptoms, and facilitate safe community reintegration."
    }
  ],
  treatmentAreas: [
  ...
  importanceNote: "Early and intensive brain injury rehabilitation is crucial for optimal recovery outcomes. Research demonstrates that structured, goal-oriented therapy promotes neuroplasticity and functional recovery even in severe cases.",
  ctaMessage: "Begin your journey to recovery with our specialized brain injury rehabilitation program. Book your comprehensive assessment today."
},
"COPD": {
  title: "COPD – COPD: Breathe Easier—Advanced Pulmonary Rehabilitation for Active Living",
  ...
  importanceNote: "Pulmonary rehabilitation is the gold standard treatment for COPD, proven to reduce symptoms, improve exercise capacity, and decrease hospitalizations. Early intervention significantly improves long-term outcomes and quality of life.",
  ctaMessage: "Ready to breathe better and live fuller? Book your pulmonary rehab assessment at VitalPhysio⁺."
},
"Post-heart attack": {
  title: "Post-Heart Attack – Cardiac Rehabilitation for Heart Health and Recovery",
  ...
  highlights: [
    {
      ...
      content: "Thorough evaluation of cardiovascular fitness, risk factors, and functional capacity using ECG monitoring, stress testing, and cardiac risk stratification to develop safe, effective exercise prescriptions."
    },
    {
      title: "Medically Supervised Exercise Training", 
      content: "Progressive aerobic and resistance training programs with continuous cardiac monitoring to safely improve cardiovascular fitness, strength, and endurance while reducing the risk of future cardiac events."
    },
    {
      title: "Risk Factor Modification",
      content: "Comprehensive education and support for lifestyle changes including nutrition counseling, smoking cessation, stress management, and medication adherence to reduce cardiovascular risk factors."
    },
    {
      title: "Psychological Support and Education",
      content: "Addressing anxiety, depression, and fear related to heart disease while providing education about heart-healthy living, activity modification, and recognizing warning signs."
    }
  ],
  treatmentAreas: [
  ...
  importanceNote: "Cardiac rehabilitation after heart attack reduces mortality by 20-25% and significantly improves quality of life. Early participation in structured programs is essential for optimal recovery and prevention of future cardiac events.",
  ctaMessage: "Take control of your heart health with our comprehensive cardiac rehabilitation program. Book your assessment for a stronger, healthier future."
},
"Breathing difficulties": {
  title: "Breathing Difficulties – Respiratory Physiotherapy for Better Breathing",
  ...
  highlights: [
    {
      ...
      content: "Detailed evaluation of breathing patterns, lung function, airway clearance needs, and functional limitations to develop targeted treatment plans for optimal respiratory health."
    },
    {
      title: "Airway Clearance Techniques", 
      content: "Evidence-based methods including chest physiotherapy, postural drainage, breathing exercises, and mechanical aids to clear secretions, improve ventilation, and enhance oxygen delivery."
    },
    {
      title: "Breathing Retraining and Exercise",
      content: "Specialized breathing techniques, inspiratory muscle training, and progressive exercise programs to strengthen respiratory muscles and improve breathing efficiency during daily activities."
    },
    {
      title: "Education and Self-Management",
      content: "Patient and family education on breathing techniques, energy conservation, inhaler use, and early recognition of respiratory complications for long-term management."
    }
  ],
  treatmentAreas: [
  ...
  importanceNote: "Early respiratory physiotherapy intervention significantly improves breathing function, prevents complications, and enhances recovery outcomes. Specialized breathing techniques can provide immediate relief and long-term benefits.",
  ctaMessage: "Breathe easier with our specialized respiratory physiotherapy program. Book your assessment for improved breathing and better quality of life."
},
"Chest conditions": {
  title: "Chest Conditions – Comprehensive Chest Physiotherapy for Respiratory Health",
  ...
  highlights: [
    {
      ...
      content: "Thorough evaluation of chest wall mechanics, respiratory muscle function, breathing patterns, and functional capacity to identify specific impairments and develop targeted treatment approaches."
    },
    {
      title: "Specialized Chest Physiotherapy Techniques", 
      content: "Manual chest therapy, rib mobilization, breathing pattern correction, postural drainage, percussion and vibration techniques, and specialized positioning to optimize chest wall mobility and respiratory function."
    },
    {
      title: "Functional Rehabilitation",
      content: "Progressive exercise programs, activity modification, and movement retraining to improve tolerance for daily activities while managing respiratory symptoms and chest discomfort."
    },
    {
      title: "Patient Education and Self-Care",
      content: "Comprehensive education on condition management, breathing exercises, energy conservation techniques, and home programs to maintain respiratory health and prevent complications."
    }
  ],
  treatmentAreas: [
  ...
  importanceNote: "Specialized chest physiotherapy significantly improves respiratory function, reduces symptoms, and enhances quality of life for various chest conditions. Early intervention prevents complications and optimizes long-term outcomes.",
  ctaMessage: "Get specialized care for your chest condition with our comprehensive physiotherapy program. Book your assessment for targeted, effective treatment."
},
"Cardiac rehabilitation": {
  title: "Cardiac Rehabilitation – Comprehensive Heart Health Recovery and Prevention",
  ...
  highlights: [
    {
      title: "Medically Supervised Exercise Training",
      content: "Progressive, individualized exercise programs with continuous cardiac monitoring, including aerobic conditioning, resistance training, and flexibility exercises designed to safely improve cardiovascular fitness and functional capacity."
    },
    {
      title: "Comprehensive Risk Factor Management", 
      content: "Systematic approach to modifying cardiovascular risk factors including blood pressure management, cholesterol control, diabetes management, weight reduction, smoking cessation, and stress reduction through evidence-based interventions."
    },
    {
      title: "Patient Education and Lifestyle Modification",
      content: "Extensive education on heart-healthy living, nutrition counseling, medication management, symptom recognition, and lifestyle changes to support long-term cardiovascular health and prevent disease progression."
    },
    {
      title: "Psychosocial Support and Counseling",
      content: "Addressing psychological aspects of heart disease including anxiety, depression, and lifestyle adjustment through counseling, support groups, and stress management techniques to promote overall well-being."
    }
  ],
  treatmentAreas: [
  ...
  importanceNote: "Cardiac rehabilitation reduces cardiovascular mortality by 20-25% and significantly improves quality of life, exercise capacity, and psychological well-being. Participation in comprehensive programs is essential for optimal recovery and secondary prevention.",
  ctaMessage: "Invest in your heart health with our comprehensive cardiac rehabilitation program. Book your assessment to start your journey toward optimal cardiovascular wellness."
},
"Pelvic floor dysfunction": {
  title: "Pelvic Floor Dysfunction – Pelvic Floor Dysfunction: Restore Control, Comfort, and Confidence",
  ...
  highlights: [
    {
      ...
      content: "Detailed muscle, nerve, and connective tissue assessment—including manometry, EMG, and advanced digital palpation. Tailored diagnosis for stress/urge incontinence, prolapse, pelvic pain, sexual dysfunction, postpartum and post-prostate cases."
    },
    {
      title: "Game Changer for Fast, Comfortable, Non-Invasive Treatment", 
      content: "Repetitive Peripheral Magnetic Stimulation (rPMS): rPMS UI Chair delivers focused, painless magnetic field pulses, activating pelvic floor and accessory muscles up to 25Hz/2.5T to restore strength, endurance, and control—no undressing or internal probes required."
    },
    {
      title: "Scientific benefits",
      content: "Proven rapid improvement for stress/urge incontinence, urgency-frequency syndromes, incomplete voiding, mild prolapse, sexual function, and postpartum recovery. Suitable for both men and women—including after prostatectomy or gynecological surgery. Facilitates deep, fatigue-resistant muscle contractions unreachable by voluntary exercise, making it ideal for weak, neurogenic, painful or post-op pelvic floors. Efficient, pain-free, and comfortable—patients are seated, fully clothed, for 15–30 minute protocols, twice weekly."
    },
    {
      title: "Paired with Biofeedback and Manual Therapy",
      content: "Use of real-time biofeedback, dedicated pelvic floor exercise, behavioral training, soft tissue work, and home programs for comprehensive recovery."
    },
    {
      title: "Supporting Modalities",
      content: "Electrical stimulation, manual therapy, relaxation/mobility, lifestyle education, and core strengthening as indicated. Full privacy and gender-sensitive care."
    }
  ],
  treatmentAreas: [
  ...
  importanceNote: "Advanced pelvic floor rehabilitation significantly improves quality of life and functional outcomes for various pelvic floor disorders. Evidence shows that specialized physiotherapy combined with innovative technologies like rPMS provides superior results compared to traditional approaches alone.",
  ctaMessage: "Ready for lasting pelvic wellness? Book your private, advanced pelvic floor assessment—including rPMS UI Chair therapy—at VitalPhysio⁺ today."
},
"Pregnancy-related pain": {
  title: "Pregnancy-Related Pain – Pregnancy-Related Pain: Comfortable Mothers, Healthy Pregnancies",
  ...
  highlights: [
    {
      ...
      content: "Specialized evaluation of pelvic alignment, postural changes, muscle imbalances, and daily function, tailored to stage of pregnancy and health. Screening for diastasis recti, sciatica, round ligament pain, and underlying support problems."
    },
    {
      title: "Personalized, Evidence-Based Therapy", 
      content: "Manual therapy & soft tissue release: Gentle, hands-on treatment to ease tension, reduce nerve compression, and relieve joint pain. Therapeutic exercise: Functional stability exercises, core and pelvic girdle strengthening, stretching, and flexibility work proven to reduce pain and restore balance. Postural & ergonomic support: Education and training in optimal movement, sleeping, and work positions for pregnancy comfort. Support devices: Guidance on maternity belts or supports when indicated for pelvic pain, instability, or back discomfort. Water-based therapy (if eligible): Aquatic exercise for gentle, pain-free relief, particularly in late pregnancy or severe back/pelvic pain."
    },
    {
      title: "Pain Management Modalities",
      content: "Use of safe modalities including TENS (where appropriate), heat/cold, and safe relaxation/mind-body techniques. Comprehensive, multi-modal approach to manage complex or severe pain."
    },
    {
      title: "Education & Empowerment",
      content: "Birth prep training, self-care routines, and movement strategies to minimize pain and prepare for labor and postpartum."
    },
    {
      title: "Digital & In-Person Options",
      content: "Support for continuity of care—including telephysio, mobile resources, and tailored home routines for ongoing improvement."
    }
  ],
  treatmentAreas: [
  ...
  importanceNote: "Safe, evidence-based physiotherapy during pregnancy significantly reduces pain, improves functional capacity, and enhances quality of life for expectant mothers. Early intervention prevents complications and supports healthy pregnancy outcomes.",
  ctaMessage: "Ready for relief and comfort during pregnancy? Book your pregnancy pain assessment at VitalPhysio⁺—Bangalore's leader for women's health physiotherapy."
},
"Incontinence": {
  title: "Incontinence – Incontinence: Restore Control—Innovative, Non-Invasive Solutions",
  subtitle: "Comprehensive Incontinence Rehabilitation at VitalPhysio⁺ Featuring rPMS UI Chair",
  ...
  highlights: [
    {
      ...
      content: "The UI Chair uses focused, high-intensity repetitive magnetic pulses to stimulate the pelvic floor muscles—activating thousands of powerful contractions in a single session, far beyond what is possible with voluntary Kegel exercise. Effortless therapy: Patients simply sit, fully clothed, for 15–30 minute sessions. No probes, no pain, no downtime."
    },
    {
      title: "Clinically proven for", 
      content: "Stress, urge, and mixed urinary incontinence. Fecal incontinence/urgency. Post-prostatectomy, postnatal, and menopausal cases. Failed Kegel or home exercise attempts. How it works: rPMS efficiently activates deep pelvic floor and sphincter muscles—even in those unable to perform correct voluntary contractions, a common barrier to success with exercise-based rehab. Rapid, measurable results—most patients notice improvements after the first few sessions and significant gains by the full protocol's end."
    },
    {
      title: "Pelvic Floor Muscle Training (PFMT)",
      content: "Foundation of conservative incontinence management—customized plans with digital/biofeedback support. Group/tele-rehab options available for ongoing support."
    },
    {
      title: "Biofeedback and Electrical Stimulation",
      content: "Real-time feedback to improve muscle awareness, voluntary contraction, and release. Electrical/electrostimulation complements rPMS for cases needing targeted neuromuscular re-education."
    },
    {
      title: "Manual Therapy & Behavioral Training",
      content: "Soft tissue work, bladder retraining, urgency control, and functional daily habit modification for long-lasting effects."
    },
    {
      title: "Education & Prevention",
      content: "Empowering patients (and caregivers) with bladder/bowel management strategies, home exercise routines, and lifestyle guidance."
    }
  ],
  treatmentAreas: [
  ...
  importanceNote: "Advanced incontinence rehabilitation using innovative technologies like rPMS UI Chair significantly improves quality of life and functional outcomes. Evidence shows that comprehensive, non-invasive pelvic floor therapy provides superior results for various types of incontinence.",
  ctaMessage: "Ready to regain confidence and control? Book your private incontinence rehab assessment at VitalPhysio⁺—experience the future of non-invasive pelvic floor therapy."
},
"Osteoporosis": {
  title: "Osteoporosis – Osteoporosis: Build Stronger Bones, Prevent Falls—Safe, Effective Rehabilitation",
  ...
  highlights: [
    {
      ...
      content: "Includes fracture risk evaluation, mobility/balance testing, posture analysis, and review of current health and medications. Collaboration with medical team to ensure safe rehab around DEXA scores and overall bone status."
    },
    {
      title: "Evidence-Based Physiotherapy for Osteoporosis", 
      content: "Weight-bearing & Resistance Training: Safely prescribed walking, stair climbing, resistance bands, and strength routines to maximize bone mineral density (BMD) and muscle function. Postural & Extension Exercise: Corrects kyphosis, improves back strength, and reduces vertebral fracture risk—progressions include chin tucks, scapular retractions, thoracic extension, and hip extensions. Balance, Coordination & Fall Prevention: Proven techniques such as Otago or Tai Chi, plus home hazard education, address the #1 cause of osteoporotic fracture. Flexibility & Joint Mobility Exercises: Gentle stretching to reduce stiffness, increase movement range, and ease pain. Safe Aerobic Activity: Low-impact choices (walking, stationary cycling, hydrotherapy if indicated)—leverage cardiovascular and musculoskeletal benefits."
    },
    {
      title: "Lifestyle, Nutrition, & Medication Optimization",
      content: "Counseling in bone-healthy diet (calcium, vitamin D), medical compliance, smoking/alcohol cessation, and sleep strategies. Guidance on safe daily living, home safety, and modifying activities to avoid sudden/jarring movements or high fall risk."
    },
    {
      title: "Progress Tracking & Support",
      content: "Milestone-based progress checks, home programs, digital/wearable reminders, and motivational coaching for adherence and prevention."
    }
  ],
  treatmentAreas: [
  ...
  importanceNote: "Evidence-based osteoporosis rehabilitation significantly improves bone density, reduces fracture risk, and enhances quality of life. Early intervention with specialized physiotherapy can slow bone loss progression and maintain independence for longer periods.",
  ctaMessage: "Ready to protect your bones and independence? Book a comprehensive osteoporosis assessment at VitalPhysio⁺."
},
"Fall prevention": {
  title: "Fall Prevention – Fall Prevention: Stay Strong, Stay Independent—Geriatric Physiotherapy for Safety and Confidence",
  subtitle: "Comprehensive Fall Prevention Program for Seniors at VitalPhysio⁺",
  ...
  highlights: [
    {
      ...
      content: "Screening for strength, balance, gait, vision, home hazards, medications, and chronic conditions (using global CPGs and the CDC STEADI/WHO protocols). Individualized risk profiling for every patient—covering prior falls, mobility issues, dizziness/vertigo, continence, osteoporosis, and daily environment."
    },
    {
      title: "Targeted, Evidence-Based Interventions", 
      content: "Balance and Proprioception Training: Dynamic and static exercises incorporating Tai Chi, Otago, and state-of-the-art equipment to improve stability. Strength and Endurance Programs: Upper/lower body, core, and postural muscle strengthening using weights, resistance bands, and functional movement. Gait and Mobility Rehabilitation: Gait analysis, walking retraining, and safe use of assistive devices (canes, walkers, orthoses, footwear review). Vestibular and Vision Support: Therapy for dizziness, vertigo, and vision-related instability."
    },
    {
      title: "Home Hazard Assessment and Modification",
      content: "In-clinic and home visits to identify and fix slippery floors, poor lighting, loose rugs, and other risks—protecting safety at every step. Education in footwear, clothing, and adaptive equipment use."
    },
    {
      title: "Medication, Bone Health, and Continence Review",
      content: "Collaboration with primary care, pharmacy, and specialty providers for holistic fall prevention."
    },
    {
      title: "Education & Motivation",
      content: "Empowerment for patients and families on safe transfers, fall recovery, and maintaining independence. Technology for monitoring, reminders, and support, plus group and individual program options."
    }
  ],
  treatmentAreas: [
  ...
  importanceNote: "Evidence-based fall prevention programs significantly reduce fall rates by 20-30% in older adults. Early intervention with comprehensive assessment and targeted training prevents injuries and maintains independence longer.",
  ctaMessage: "Ready to prevent falls and stay independent? Book your senior fall prevention assessment at VitalPhysio⁺."
},
"Balance training": {
  title: "Balance Training – Balance Training: Restore Stability—Reduce Falls, Move with Confidence",
  ...
  importanceNote: "Targeted balance training significantly improves stability and reduces fall risk by up to 40%. Evidence shows that progressive, multi-modal balance interventions enhance confidence and maintain independence in various populations.",
  ctaMessage: "Ready for better balance and new confidence? Book your advanced balance assessment at VitalPhysio⁺—Bangalore's home for falls prevention and mobility restoration."
},
"Mobility issues": {
  title: "Mobility Issues – Mobility Issues: Move Freely—Regain Independence, Confidence, and Participation",
  ...
  importanceNote: "Early mobility rehabilitation significantly improves functional outcomes and quality of life. Evidence shows that comprehensive, goal-oriented mobility training reduces disability and enhances independence across various conditions.",
  ctaMessage: "Ready to move further, safer, and live life your way? Book your advanced mobility evaluation at VitalPhysio⁺."
},
"Age-related conditions": {
  title: "Age-Related Conditions – Age-Related Conditions: Active Aging—Restore Strength, Mobility, and Independence",
  subtitle: "Expert Rehabilitation for Age-Related Conditions at VitalPhysio⁺",
  ...
  importanceNote: "Evidence-based geriatric rehabilitation significantly improves functional outcomes and quality of life for older adults. Early intervention with comprehensive assessment and targeted therapy prevents decline and maintains independence for longer periods.",
  ctaMessage: "Ready for active, independent aging? Book your comprehensive geriatric assessment at VitalPhysio⁺."
},
"Strength maintenance": {
  title: "Strength Maintenance – Strength Maintenance: Stay Strong, Active & Independent—Physiotherapy for Life",
  ...
  highlights: [
    {
      ...
      content: "Assessment of muscle power, endurance, mobility, posture, and daily activities using advanced tools (grip strength, 1RM testing, functional tasks). Tracking sarcopenia risk and physical frailty for tailored intervention."
    },
    {
      title: "Targeted, Individualized Progressive Resistance Training", 
      content: "Programs based on optimal dosage: ~3 weekly sessions, multi-set/rep routines at 50%–85% of maximal effort, as appropriate. Focused on major muscle groups—legs, hips, core, arms—using bands, free weights, bodyweight, and machines. Adaptable to fitness level, orthopaedic/medical status, and rehab phase. Emphasis on progressive overload, controlled movement, and proper technique for safe gains in muscle quality and strength."
    },
    {
      title: "Integrated Functional Strength Activities",
      content: "Sit-to-stand, stair climbing, walking uphill, reaching, and real-world lifting—building power, balance, and functional ability. Balance and agility drills to complement muscle work and prevent falls."
    },
    {
      title: "Joint, Bone & Cardiovascular Health Focus",
      content: "Combines loading for bones/osteo prevention with strength for joint protection. Minimal risk of injury when expertly supervised—especially important in seniors or those with pain."
    },
    {
      title: "Motivation, Adherence & Lifelong Support",
      content: "Group and solo options, digital/app-based programs, educated tracking, and periodic retesting for continued progress."
    }
  ],
  treatmentAreas: [
  ...
  importanceNote: "Evidence-based strength maintenance programs significantly improve muscle mass, bone density, and functional capacity. Regular resistance training reduces fall risk and maintains independence while enhancing overall quality of life.",
  ctaMessage: "Ready for greater strength, vitality, and self-reliance? Book your physiotherapy-based strength maintenance consult at VitalPhysio⁺—Bangalore's go-to for lifelong muscle health."
},
"Urinary incontinence": {
  title: "Urinary Incontinence – Expert Urinary Incontinence Rehabilitation at VitalPhysio⁺ with UI Chair",
  ...
  highlights: [
    {
      ...
      content: "Delivers focused, repetitive magnetic pulses to painlessly stimulate and strengthen the entire pelvic floor—initiating thousands of deep contractions in a short, fully clothed session. Ideal for those unable to contract pelvic floor muscles (\"failed Kegel\" or poor muscle awareness), post-childbirth, after prostatectomy, and for advanced age or neurologic cases. Rapid improvements for stress, urge, and mixed incontinence—with clinical results often reported after just a few treatment sessions. Fully non-invasive: No electrodes, no probes, no discomfort, no recovery time."
    },
    {
      title: "Comprehensive Pelvic Floor Physiotherapy", 
      content: "Pelvic Floor Muscle Training (PFMT): The global first-line for all incontinence types—guided, progressive, and adapted for strength, power, and endurance. Biofeedback: Provides instant feedback to ensure correct, high-quality contractions—especially for those with reduced muscle perception. Electrical Stimulation & Behavioral Retraining: Can complement rPMS for stubborn cases, urgency, or detrusor instability. The \"Knack\" and Functional Training: Pre-emptive contraction coaching, real-world movement correction, and bladder programming."
    },
    {
      title: "Holistic Support & Prevention",
      content: "Education in bladder and fluid management, daily habit modification, safe exercise, and long-term maintenance. Integration with urology, gynecology, and medical providers as needed."
    }
  ],
  treatmentAreas: [
  ...
  importanceNote: "Advanced urinary incontinence rehabilitation using innovative technologies like rPMS UI Chair significantly improves quality of life and functional outcomes. Evidence shows that comprehensive, non-invasive pelvic floor therapy provides superior results for all types of urinary incontinence.",
  ctaMessage: "Book your confidential assessment for incontinence at VitalPhysio⁺—experience modern, effortless, life-changing pelvic health in Bangalore."
},
"Faecal incontinence": {
  title: "Faecal Incontinence – Faecal Incontinence: Restore Control—Compassionate, Effective, Non-Invasive Rehab",
  subtitle: "Advanced Faecal Incontinence Physiotherapy at VitalPhysio⁺ featuring rPMS UI Chair",
  ...
  importanceNote: "Advanced faecal incontinence rehabilitation using innovative technologies like rPMS UI Chair significantly improves quality of life and functional outcomes. Evidence shows that comprehensive, non-invasive pelvic floor therapy provides superior results for various types of faecal incontinence.",
  ctaMessage: "Ready to regain freedom and bowel control? Book a private faecal incontinence assessment at VitalPhysio⁺—Authority for advanced pelvic health and continence restoration."
},
"Sexual health": {
  title: "Sexual Health – Advanced Sexual Health and Pelvic Rehab at VitalPhysio⁺ (Including Focus on Erectile Dysfunction)",
  ...
  importanceNote: "Advanced sexual health rehabilitation using innovative technologies and comprehensive pelvic floor therapy significantly improves intimate function and quality of life. Evidence shows that non-pharmacological approaches provide lasting results for various sexual health concerns.",
  ctaMessage: "Ready for better sexual health or ED recovery? Book your confidential sexual health assessment at VitalPhysio⁺—Leader in noninvasive pelvic and sexual rehab."
},
"Pelvic pain": {
  title: "Pelvic Pain – Pelvic Pain: Restore Comfort, Function & Confidence—Bangalore's Leader in Pelvic Floor Rehab",
  ...
  highlights: [
    {
      title: "Comprehensive Assessment",
      content: "Thorough pelvic floor, hip, spine, and abdominal muscle exam—including internal and external assessment as needed. Biopsychosocial model: pain sources, triggers, posture, and behavioral/lifestyle patterns."
    },
    {
      title: "Manual Therapy & Myofascial Release", 
      content: "Gentle internal (when indicated) and external techniques, trigger point therapy, scar/adhesion release, and nerve gliding—universally agreed as first-line for most pelvic pain syndromes."
    },
    {
      title: "Pelvic Floor Muscle Re-education",
      content: "Focused on relaxation, down-training, and movement retraining—not just strengthening. This targets abnormal tone/spasm and restores healthy function."
    },
    {
      title: "Biofeedback & Electrical Stimulation",
      content: "Teaches accurate relaxation/contraction and improves body awareness for \"stubborn\" pelvic floor pain, particularly with dysfunctional patterns."
    },
    {
      title: "Behavioral & Cognitive Therapy Integration",
      content: "Education, pain neuroscience, graded exposure, stress reduction and functional training for long-term progress."
    },
    {
      title: "rPMS UI Chair & Complementary Modalities",
      content: "Used selectively for muscle relaxation, pain control, deep muscle engagement, and for difficult/complex pain cases. Supported with heat/cold, stretching, yoga/relaxation, and digital pain diary tools."
    },
    {
      title: "Collaborative, Compassionate Team",
      content: "Interdisciplinary work with physicians (urology, gyn, GI, pain), psychologist, and sexual health specialists for holistic support."
    }
  ],
  treatmentAreas: [
  ...
  importanceNote: "Evidence-based pelvic pain rehabilitation significantly improves quality of life and functional outcomes. Specialized physiotherapy addressing both physical and psychological aspects of pelvic pain provides superior results compared to single-modality treatments.",
  ctaMessage: "Ready to end pelvic pain and reclaim comfort? Book your confidential evaluation at VitalPhysio⁺—the first step to lasting relief and restored wellbeing."
},
"Intimate wellness": {
  title: "Intimate Wellness – Intimate Wellness: Empowered Comfort, Confidence & Connection—Specialist Pelvic & Sexual Health Physiotherapy",
  ...
  highlights: [
    {
      ...
      content: "Addresses tone, strength, endurance, and relaxation—essential for comfort, arousal, orgasm, and control."
    },
    {
      title: "Biofeedback, rPMS, & Manual Therapies", 
      content: "Painless, tech-enabled options like rPMS UI Chair (deep pelvic floor activation—especially for sexual dysfunction and post-surgical/women's/men's health), biofeedback for under/overactive muscles, and gentle internal/external release as indicated."
    },
    {
      title: "Sexual Function Coaching, Cognitive Tools & Education",
      content: "Up-to-date, open dialogue about arousal, desire, pain, habit change, and communication. For oncology/menopause, coordinated with medical team to optimize safety and confidence. Guidance in lubricants, dilators, mindfulness/relaxation, and safe touch or device use if desired."
    },
    {
      title: "Partner & Emotional Wellness Support",
      content: "Includes partner strategies, emotional counseling, and support for self-acceptance, relationship enhancement, and intimacy restoration."
    },
    {
      title: "Inclusive, Lifestyle-Focused Care",
      content: "All ages, all orientations. Every session is private, affirming, and nonjudgmental."
    }
  ],
  treatmentAreas: [
  ...
  importanceNote: "Comprehensive intimate wellness rehabilitation significantly improves sexual function, relationship satisfaction, and overall quality of life. Evidence shows that specialized physiotherapy addressing both physical and psychological aspects of intimate health provides superior outcomes.",
  ctaMessage: "Ready for more comfortable, confident, and joyful intimacy? Book your private intimate wellness consult at VitalPhysio⁺—Benchmark for sexual and pelvic health."
},
"Remote consultation": {
  title: "Remote Consultation – Remote Consultation (Tele-Rehabilitation): Expert Guidance Wherever You Are",
  subtitle: "VitalPhysio⁺ Remote Consult: Support for Your Home Exercise Journey",
  ...
  highlights: [
    {
      ...
      content: "Flexible, private, and secure. Sessions are scheduled follow-ups (not first assessments), so your therapist already knows your condition and program."
    },
    {
      title: "Guided Home Exercise Program (HEP) Support", 
      content: "Real-time correction on form/position, exercise progression, and daily/lifestyle tips. Digital monitoring, exercise videos, and reminders when appropriate. Collaborative progress review, troubleshooting, and prompt problem-solving."
    },
    {
      title: "Patient-First Safety & Quality",
      content: "All Home & Tele sessions are led by skilled VitalPhysio⁺ therapists, using validated protocols and technology. Initiation home visits for post-surgical patients only—clinic-based therapy will be resumed as soon as patient safely ambulates."
    },
    {
      title: "No \"one-size-fits-all\" tele-therapy",
      content: "Your tele-rehab is custom, goal-based, and always tied to your clinic plan—never generic, never solo."
    },
    {
      title: "Clinic-Integrated, Personalized Care",
      content: "Every tele-rehab session is uniquely tailored to your diagnosis, surgical recovery, and stage of rehab. Not a generic \"video physio\"—these are targeted support sessions, not substitutes for full, hands-on assessment or comprehensive treatment."
    }
  ],
  treatmentAreas: [
  ...
  importanceNote: "Tele-rehabilitation as a complement to in-person care significantly improves adherence to treatment programs and enhances outcomes. Evidence shows that guided remote exercise supervision maintains continuity of care while ensuring safety and effectiveness.",
  ctaMessage: "Book your next VitalPhysio⁺ Tele-Rehab Session—staying connected for continuous, confident recovery at home and in the clinic."
},
"Home exercises": {
  title: "Home Exercises – Home Exercises: Evidence-Based Extension of Your Clinic Program",
  subtitle: "Home Exercise Program (HEP) at VitalPhysio⁺: Empowering Results Beyond the Clinic",
  ...
  highlights: [
    {
      ...
      content: "Every home program is built on the same clinical guidelines and global research used at VitalPhysio⁺—matched in difficulty and focus to your recovery phase, whether early, mid, or late-stage. Prescriptions evolve as your clinic therapy progresses (e.g., range-of-motion in early post-op, strength and skill in later stages, endurance and prevention on discharge)."
    },
    {
      title: "Patient-Condition Specific", 
      content: "No generic exercise sheets. Every HEP is customized for your diagnosis, physical status, pain levels, personal goals, and functional needs. Regular review and real-time adjustment based on your progress, challenges, and therapist feedback."
    },
    {
      title: "Integrated with In-Clinic Care",
      content: "HEPs are never \"standalone\" or internet-based—they reinforce and build upon the exact techniques, stretches, and strengthening you are already doing (or learning) at VitalPhysio⁺. Your therapist will demonstrate, adjust, and track your exercises, ensuring safety and effectiveness."
    },
    {
      title: "Digital & Print Options, plus Tele-Rehab Support",
      content: "Access home exercises via secure video/app, print handouts, or live tele-rehab guidance—making it easier than ever to stay on track and accountable."
    },
    {
      title: "Phase-Matched Progression",
      content: "Your exercises progress in tandem with your therapy at VitalPhysio⁺—from protecting healing tissue in early stages, to strength and balance as you get stronger, to return-to-activity plans before discharge."
    }
  ],
  treatmentAreas: [
  ...
  importanceNote: "Consistent, supervised home exercise is proven to speed up recovery, maximize your outcome, and cement gains made at the clinic—even if you only have a few supervised hours per week. Evidence-based home exercise programs are essential for lasting rehabilitation success.",
  ctaMessage: "Ready for better results with your next home program? Book your clinical review at VitalPhysio⁺—and supercharge your therapy, wherever you are!"
},
"Follow-up care": {
  title: "Follow-Up Care – Follow-Up Care: The Bridge to Success—Continuous Support, Lasting Results",
  ...
  highlights: [
    {
      ...
      content: "Every follow-up visit is a checkpoint to measure gains, address setbacks, and make data-driven adjustments to your therapy, home exercise routine, or device usage. Therapists use evidence-based protocols, clinical scales, and your feedback to guide changes—making your care precise and efficient."
    },
    {
      title: "Dynamic, Personalized Plan Adjustment", 
      content: "Your follow-up isn't just a check-in; it's a scientific review of what's working, what's not, and what you need next to move forward. All changes—more challenge, new exercises, technique refinement—are tailored to your body's unique healing response and your personal goals."
    },
    {
      title: "Open Communication & Partnership",
      content: "Follow-ups build trust, foster active dialogue, and give space for your questions and concerns. They help you understand your progress and motivate you to maximize adherence between clinic visits, especially with home exercise."
    },
    {
      title: "Long-Term Success & Prevention",
      content: "Even after symptoms resolve, booster follow-ups may be scheduled to ensure relapses are prevented, goals are maintained, and the transition to long-term self-management is smooth."
    },
    {
      title: "Clinic and Virtual Options",
      content: "In-clinic or (when appropriate) tele-review—adapted to your circumstances, needs, and rehab stage. All follow-up protocols are phase-matched and condition-specific, just like the rest of your care at VitalPhysio⁺."
    }
  ],
  treatmentAreas: [
  ...
  importanceNote: "Regular, planned follow-up care is central to safe, sustainable, and maximal recovery. Evidence shows that structured follow-up protocols significantly improve long-term outcomes and prevent relapses in physiotherapy patients.",
  ctaMessage: "Ready to make your results last? Book your next follow-up at VitalPhysio⁺—and keep moving forward, every step of the way!"
},
"Accessibility needs": {
  title: "Accessibility Needs – Accessibility Needs: Inclusive Care—Dignity, Independence & Full Participation",
  ...
  highlights: [
    {
      ...
      content: "Fully wheelchair-accessible entrances, restrooms, and treatment areas designed for universal access and comfort."
    },
    {
      title: "Inclusive, Individualized Care", 
      content: "Therapists with expertise in neurological and musculoskeletal rehab for physical, intellectual, sensory, and mixed disabilities. Adapted exercise, assistive tech, and mobility aids for people with limb loss, CP, SCI, stroke, amputation, or complex needs. Communication supports: visual materials, easy-read instructions, and translation/interpretation as needed."
    },
    {
      title: "Technology for Access",
      content: "Wearable devices, tele-rehab, motion sensors, and software for customized, consistent therapy—delivering care to those who may find in-person visits challenging at times. Support for digital accessibility—ensuring web/tele-rehab materials are screen-reader friendly, simple, and mobile-optimized."
    },
    {
      title: "Inclusive, Compassionate Approach",
      content: "Clinicians trained in dignity, consent, and empowerment for all bodies, abilities, and backgrounds. Collaborative care plans—always developed with the patient and caregivers, not just for them."
    },
    {
      title: "Family & Community Engagement",
      content: "Accessible education, caregiver training, peer/advocacy links, and close teamwork with local support services and NGOs. Regular review and feedback to update support as needs evolve."
    }
  ],
  treatmentAreas: [
  ...
  importanceNote: "Universal accessibility in healthcare significantly improves outcomes for people with disabilities. Evidence shows that barrier-free environments and inclusive care approaches enhance participation, independence, and quality of life for all patients.",
  ctaMessage: "Ready for dignified, barrier-free rehabilitation? Book your accessible care consult at VitalPhysio⁺."
},
                ...
                >
                  ...
                  <div className="relative p-6 md:p-8 bg-gradient-to-br from-white to-gray-50">
                    <div className="flex items-start justify-between mb-6">
                      <div className="flex items-center gap-4 flex-1">
                        <div className={`w-16 h-16 md:w-20 md:h-20 rounded-xl bg-white border-3 ${service.borderColor} flex items-center justify-center shadow-md`}>
                          <service.icon className={`w-12 h-12 md:w-14 md:h-14 ${service.iconColor}`} />
                        </div>
                        <div className="flex-1">
                          <h3 className="text-2xl md:text-3xl font-bold text-gray-900 mb-2 leading-tight">
                            {service.title}
                          </h3>
                          <div className={`w-16 h-1 ${service.accentColor} rounded-full`}></div>
                        </div>
                      </div>
                  ...
                  <div className="px-6 md:px-8 pb-6 md:pb-8 bg-white flex-grow flex flex-col">
                    ...
                    <div className="flex items-center justify-between mt-auto pt-4 border-t border-gray-100">
                      ...
                      <div className={`px-3 py-1 ${service.accentColor} bg-opacity-10 text-gray-700 text-xs font-medium rounded-full`}>
  ...
  <section className="bg-white py-20 md:py-32">
    <div className="container mx-auto px-6">
      ...
      <motion.div
        ...
        viewport={{ once: true }}
      >
        <AutoCarousel items={coreServicesData} onConditionClick={onConditionClick} />
      </motion.div>
    </div>
  </section>
);
