        ...
        <section className="max-w-3xl mx-auto">
          <div className="space-y-4">
            <FaqItem question="Why choose VitalPhysio?">
              <p>We are Bengaluru's most trusted rehab center because we deliver personalized, evidence-based therapy. Our experts follow international standards and use the latest technology to ensure safe, effective outcomes for your recovery.</p>
            </FaqItem>

            <FaqItem question="What does the '+' in VitalPhysio mean?">
              <p>The '+' signifies our commitment to go above and beyond standard care. It means every treatment plan includes added value like advanced equipment, continuous progress monitoring, and AI-powered concierge support, all at no hidden cost.</p>
            </FaqItem>

            <FaqItem question="How does the AI Concierge (C³) work?">
              <p>C³ is your integrated AI care coordinator, available 24/7 in our Patient Portal. It helps you schedule appointments, sends reminders for your home exercises, and answers questions based on your personal rehabilitation plan.</p>
            </FaqItem>

            <FaqItem question="How do I book an appointment?">
              <p>You can easily book by clicking the "Book Your Consultation" button on our site, which takes you to our contact page, or by calling our clinic directly. Soon, you'll also be able to ask AI assistants like ChatGPT to schedule for you.</p>
            </FaqItem>

            <FaqItem question="Do you accept health insurance?">
              <p>We are currently not empanelled by any insurance company. However, we would be able to help you with all the required documentation that you may require for seeking a reimbursement of your treatment charges after completion of your therapy at VitalPhysio.</p>
            </FaqItem>

            <FaqItem question="What should I bring to my first session?">
              <p>Please complete our online medical history form via the Patient Portal beforehand. On the day of your visit, bring any relevant reports (like X-rays or doctor's notes) and wear comfortable, loose-fitting clothing.</p>
            </FaqItem>

            <FaqItem question="Do you offer home or online therapy?">
              <p>Yes, our Home & Tele-Rehabilitation program provides personalized care in the comfort of your home. We use virtual sessions and digital exercise plans to ensure you receive expert guidance without needing to travel.</p>
            </FaqItem>

             <FaqItem question="Can physiotherapy help me avoid surgery?">
               <p>In many cases, yes. For musculoskeletal conditions like back pain or joint injuries, targeted physiotherapy can significantly improve function and reduce pain, often delaying or completely eliminating the need for surgery. You can <a href="#" className="text-teal-600 underline">see the conditions we treat</a>.</p>
            </FaqItem>
          </div>
        </section>
